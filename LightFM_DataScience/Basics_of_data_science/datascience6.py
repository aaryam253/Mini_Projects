# Gamma Ray Detector - Genetic Programming
...
training_indices, validation_indices = training_indices, testing_indices = traing_test_slit(tele.index, stratify= tele_class, train_size=0.75, test_size=0.25)
